...
const COMPARISON = {
  ...
  features: [
    ...
    { name: 'Offline PWA',        cli: 'no',      mobile: 'yes'     },
    { name: 'Touch UI',           cli: 'no',      mobile: 'yes'     },
    { name: 'Gesture Controls',   cli: 'no',      mobile: 'yes'     },
    { name: 'Wake Lock',          cli: 'no',      mobile: 'yes'     },
    { name: 'Haptic Feedback',    cli: 'no',      mobile: 'yes'     },
    { name: 'Web Share',          cli: 'no',      mobile: 'yes'     },
    { name: 'Battery Monitor',    cli: 'no',      mobile: 'yes'     },
    { name: 'Push Notifications', cli: 'no',      mobile: 'partial' },
    { name: 'Background Sync',    cli: 'no',      mobile: 'partial' },
  ],
};
